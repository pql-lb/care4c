        ...
        <div className="bg-background relative overflow-hidden">
            ...
            <div className="wrapper ">
                <div className="flex md:flex-row flex-col my-10">
                    <div className="md:w-[50%]">
                        ...
                        <div className="text-white font-poppins">
                            <div className="mb-10 flex items-center">
                                <svg
                                    className="max-h-[45px] w-[50px] mr-[50px]"
                            ...
                            <div className="mb-10 flex items-center">
                                <svg
                                    className="max-h-[38px] -translate-y-[4px] w-[50px] mr-[50px] "
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 512 512"
                                >
                                    <path
                            ...
                            <div className="mb-10 flex items-center">
                                ...
                                >
                                    ...
                                    <path
                                        ...
                                        fill-opacity="1"
                                        fill-rule="nonzero"
                                        className="fill-gradient1 stroke-none"
                                    />
                    ...
                    <img
                        className="shadow-[-5px_5px_12px_1px_rgba(0,0,0,0.5)] rounded-xl max-h-[400px] object-cover md:absolute right-0 md:w-[50%]"
